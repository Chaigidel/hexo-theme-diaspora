...
const icon_providers = {
    fontawesome: 'https://cdn.bootcss.com/font-awesome/5.4.1/css/all.min.css'
};

module.exports = function (hexo) {
    hexo.extend.helper.register('cdn', function (_package, version, filename) {
        let provider = '[cdnjs]https://cdnjs.loli.net/ajax/libs/${ package }/${ version }/${ filename }';
    ...
    hexo.extend.helper.register('fontcdn', function (fontName, type = 'css') {
        let provider = 'https://fonts.loli.net/${type}?family=${fontname}';
